...
class CelfMetroGuiaTelefonicaLayout extends RastyLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/CelfMetroGuiaTelefonicaLayout.htm" );
	...
	public function getType(){
		...
		return "CelfMetroGuiaTelefonicaLayout";
