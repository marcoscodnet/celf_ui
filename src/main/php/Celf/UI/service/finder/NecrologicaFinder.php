<?php
namespace Celf\UI\service\finder;
...
/**
 * 
 * Finder para necrologicas.
 * 
 * @author Marcos
 * @since 04/05/2018
 */
class NecrologicaFinder implements  IAutocompleteFinder {
	...
	public function findEntitiesByText( $text, $parent=null ){
		...
		$uiCriteria = new UINecrologicaCriteria();
		$uiCriteria->setNombre( $text );
		
		$uiCriteria->setRowPerPage( 10 );
		return UIServiceFactory::getUINecrologicaService()->getList($uiCriteria);	
	}
	...
	function findEntityByCode( $code, $parent=null ){
		...
		return UIServiceFactory::getUINecrologicaService()->get( $code );
	}
	...
	public function getAttributesCallback(){
		return array("oid", "nombre", "artista");		
	}
